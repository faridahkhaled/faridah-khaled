...
Hero: Faridah Khaled the Mage
Student ID: 16006199
GitHub account: faridahkhaled

A **Chimera** bars the way near **the Red Sea coast**. It only falls to
the exact blow.
...
4. Your warcry — copy the line below exactly, including punctuation:
   ...
   "By the Red Sea coast, the Chimera surrenders!"
